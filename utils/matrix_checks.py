...
from stationary.math_helpers import kl_divergence_dict
from stationary.graph import Graph
from stationary.stationary import edges_to_edge_dict
...
def check_global_balance(edges, stationary):
    """
...
def check_eigenvalue(edges, s):
    ...
    g = Graph(edges)
    t = g.left_multiply(s)
    assert_almost_equal(kl_divergence_dict(s, t), 0, places=3)
